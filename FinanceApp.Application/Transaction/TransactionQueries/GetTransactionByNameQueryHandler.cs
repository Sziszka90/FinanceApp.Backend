...
public class GetTransactionByNameQueryHandler : IQueryHandler<GetTransactionByIdQuery, Result<GetTransactionDto>>
{
  private readonly IMapper _mapper;
  private readonly IRepository<Domain.Entities.Transaction> _transactionRepository;

  public GetTransactionByNameQueryHandler(IMapper mapper, IRepository<Domain.Entities.Transaction> transactionRepository)
  {
    _mapper = mapper;
