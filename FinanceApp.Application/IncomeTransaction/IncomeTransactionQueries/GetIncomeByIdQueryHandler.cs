...
public class GetIncomeByIdQueryHandler : IQueryHandler<GetIncomeByIdQuery, Result<GetIncomeTransactionDto>>
{
  #region Members
  ...
  public GetIncomeByIdQueryHandler(IMapper mapper, IRepository<Domain.Entities.IncomeTransaction> incomeTransactionRepository)
  {
    _mapper = mapper;
